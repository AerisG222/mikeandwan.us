...
import { ContainerBox } from '../models/ContainerBox';
import { IPhotoInfo } from '../interfaces/IPhotoInfo';
import { SaveDialog } from './SaveDialog';
import { SlideshowButton } from './SlideshowButton';
import { PhotoViewTool } from '../models/PhotoViewTool';

@Component({
    selector: 'photo',	
    directives: [ NgIf, NgClass, NgStyle, HelpDialog, CommentView, RatingView, ExifView, EffectsView, FullscreenView, CategoryLink, SaveDialog, SlideshowButton ],
    templateUrl: '/js/photos/components/PhotoView.html'
})
export class PhotoView implements AfterViewInit, OnDestroy {
    ...
    @ViewChild(HelpDialog) private _helpDialog : HelpDialog;
    @ViewChild(SaveDialog) private _saveDialog : SaveDialog;
