...
def build_size_specs(dir):
    return [
        ...
        SizeSpec("QHD (2560x1440)",      os.path.join(dir, "qhd"),      False, "2560x1440"),
        SizeSpec("4K (3840x2160)",       os.path.join(dir, "4k"),       False, "3840x2160"),
        SizeSpec("5K (5120x2880)",       os.path.join(dir, "5k"),       False, "5120x2880"),
        SizeSpec("8K (7680x4320)",       os.path.join(dir, "8k"),       False, "7680x4320"),
        SizeSpec("Original",             os.path.join(dir, "original"), False),
    ]
