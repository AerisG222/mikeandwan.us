...
namespace MawMvcApp.ViewModels.Tools.Dotnet
{
	public class PathsModel
	{
		...
		public void PreparePaths()
		{
	        ...
	        Paths.Add(new string[] {@"Path.ChangeExtension(""C:\windows\test.txt"", "".dat"")", Path.ChangeExtension(@"C:\windows\test.txt", ".dat").ToString()});
	        Paths.Add(new string[] {@"Path.ChangeExtension(""C:\windows\test.txt"", ""dat"")", Path.ChangeExtension(@"C:\windows\test.txt", "dat").ToString()});
	        Paths.Add(new string[] {@"Path.ChangeExtension(""/etc/passwd"", "".txt"")", Path.ChangeExtension("/etc/passwd", ".txt").ToString()});
	        Paths.Add(new string[] {@"Path.ChangeExtension(""/etc/passwd"", ""txt"")", Path.ChangeExtension("/etc/passwd", "txt").ToString()});
	        Paths.Add(new string[] {@"Path.ChangeExtension(""/etc/passwd/"", ""txt"")", Path.ChangeExtension("/etc/passwd/", "txt").ToString()});
	        ...
	        Paths.Add(new string[] {@"Path.HasExtension(""/etc/passwd"")", Path.HasExtension("/etc/passwd").ToString()});
	        Paths.Add(new string[] {@"Path.HasExtension(""/etc/passwd/"")", Path.HasExtension("/etc/passwd/").ToString()});
	        Paths.Add(new string[] {@"Path.HasExtension(""/etc/passwd/.txt"")", Path.HasExtension("/etc/passwd/.txt").ToString()});
	        Paths.Add(new string[] {@"Path.HasExtension(""etc/passwd"")", Path.HasExtension("etc/passwd").ToString()});
	        Paths.Add(new string[] {@"Path.HasExtension(""C:\windows\test.txt"")", Path.HasExtension(@"C:\windows\test.txt").ToString()});
	
	        Paths.Add(new string[] {@"Path.IsPathRooted(""/etc/passwd"")", Path.IsPathRooted("/etc/passwd").ToString()});
	        Paths.Add(new string[] {@"Path.IsPathRooted(""/etc/skel/"")", Path.IsPathRooted("/etc/skel/").ToString()});
	        Paths.Add(new string[] {@"Path.IsPathRooted(""C:\windows\system32"")", Path.IsPathRooted(@"C:\windows\system32").ToString()});
	        Paths.Add(new string[] {@"Path.IsPathRooted(""C:\windows\system32\"")", Path.IsPathRooted(@"C:\windows\system32\").ToString()});
	        Paths.Add(new string[] {@"Path.IsPathRooted(""etc/passwd"")", Path.IsPathRooted("etc/passwd").ToString()});
	        Paths.Add(new string[] {@"Path.IsPathRooted(""windows\system32\"")", Path.IsPathRooted(@"windows\system32\").ToString()});
		}
